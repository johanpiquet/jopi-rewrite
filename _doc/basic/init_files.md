...
Each module has a `serverInit.ts` file which is automatically called after evaluating the `index.ts` file. It exports a default function that receives the value returned by `jopiEasy.create_creatWebSiteServer()`.
