...
(function (AutomaticStartStopState) {
    ...
    AutomaticStartStopState[AutomaticStartStopState["Started"] = 2] = "Started";
    AutomaticStartStopState[AutomaticStartStopState["Stopping"] = 3] = "Stopping";
})(AutomaticStartStopState || (AutomaticStartStopState = {}));
export class AutomaticStartStop {
    _state = AutomaticStartStopState.Stopped;
    lastStartDate = 0;
    ...
    boundStop;
    constructor(params) {
        if (params.autoShutdownAfter_ms)
            this.autoShutdownAfterMs = params.autoShutdownAfter_ms;
        else
            this.autoShutdownAfterMs = ONE_MINUTE * 2;
    ...
    initialize() {
        if (this.requireTool) {
            ...
            if (toolPath === null)
                throw new ToolNotFoundError(this.requireTool);
...
//# sourceMappingURL=automaticStartStop.js.map